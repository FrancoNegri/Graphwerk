...
| [157](157-differ-reads-base-via-git-ref.md) | Differ reads base content via a git ref, not a second directory | ready | [058](../decisions/058-retire-worktree-single-directory-review.md) |
